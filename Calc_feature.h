...
public:
    ...
    static Solution Hill_climbing_with_budget_and_restart(Instance inst, string fitness, string voisinage, int budget, bool critic, bool frein, int budget_frein);
